...
///\ingroup MapElements
///\brief The GeometricShape is the base class for geometric shapes.
///
/// The GeometricShape provides the shape data for the VectorShape objects. It can be used
/// for standalone objects in collision functions.
...
///\ingroup MapElements
///\brief The VectorShape class defines the vector shape from JugiMap Editor.
///
...
public:
    ...
    VectorShape(bool _extra, int _dataFlags, const std::vector<jugimap::Parameter> &_parameters) : extra(_extra), dataFlags(_dataFlags), parameters(_parameters){}
...
private:
    ...
    bool extra = false;                                 // custom identifier
