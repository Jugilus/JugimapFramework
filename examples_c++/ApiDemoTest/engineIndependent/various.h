...
public:
    ...
    Button(int _tag, jugimap::StandardSprite *_sprite,  jugimap::Text *_stringLabel, bool _checkable):
        tag(_tag),
        sprite(_sprite),
    ...
    jugimap::Text* GetStringLabel(){ return labelText; }


private:
    int tag = 0;
    jugimap::StandardSprite *sprite = nullptr;                   // LINK
    jugimap::Text *labelText = nullptr;                        // LINK
