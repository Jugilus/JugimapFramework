...
void app::Begin(void)
{
    ...
    agk::SetWindowTitle("JugiMap API Demo Test - AGK version");
    ...
    jugimap::Scene* scene = jugimap::sceneManager->AddScene(new apiTestDemo::PlatformerSceneSceneAGK());
...
int app::Loop (void)
{
    ...
    apiTestDemo::mouse.SetScreenPosition(jugimap::Vec2f(agk::GetPointerX(), agk::GetPointerY()));
    apiTestDemo::mouse.SetPressed(agk::GetPointerState());
    apiTestDemo::mouse.SetHit(agk::GetPointerPressed());
