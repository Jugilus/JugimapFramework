...
int main()
{
    ...
    sf::RenderWindow window(sf::VideoMode(1300, 800), "JugiMap sprite timeline animation - SFML version");
    ...
    // Create scene
    jugimap::Scene* scene = jugimap::sceneManager->AddScene(new DemoSceneSFML());
