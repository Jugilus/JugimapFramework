...
MyEventHandler::MyEventHandler()
{
    ...
    //keysConversionTable[(int)ncine::KeySym::TILDE] = jugimap::KeyCode::TILDE;                     // ~
    //keysConversionTable[(int)ncine::KeySym::] = jugimap::KeyCode::HYPHEN;                    // -
    ...
    //keysConversionTable[(int)ncine::KeySym::LSUPER] = jugimap::KeyCode::LEFT_SYS;
    //keysConversionTable[(int)ncine::KeySym::RSUPER] = jugimap::KeyCode::RIGHT_SYS;
